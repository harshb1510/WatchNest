...
import { removeCartItem,decreaseCartQuantity, addToCart, clearCart, getTotal } from "../../features/cartSlice";
...
const Cart = () => {
  ...
  const decreaseQuantity = (cartItem) => {
    ...
    dispatch(decreaseQuantityOnBackend(cartItem));
  };
  
  const handleAddToCart = async (cartItem) => {
    // dispatch(addToCart(cartItem));
    dispatch(addToCartOnBackend(cartItem.product));
  };
